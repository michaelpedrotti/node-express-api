...
module.exports = require('express').Router()
    ...
    .put('/:id', isAuthenticated, isAuthorized('profile', 'update'), profileValidator, Controller.update)
    ...
    .post('/', isAuthenticated, isAuthorized('profile', 'create'), profileValidator, Controller.create)
